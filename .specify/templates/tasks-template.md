...
- [ ] T010 [P] [US1] Unit tests for [component/function] in tests/unit/test_[name].py
- [ ] T011 [P] [US1] Integration test for [component interaction] in tests/integration/test_[name].py
...
- [ ] T019 [P] [US2] Unit tests for [component/function] in tests/unit/test_[name].py
- [ ] T020 [P] [US2] Integration test for [component interaction] in tests/integration/test_[name].py
- [ ] T021 [P] [US2] Contract test for [endpoint] in tests/contract/test_[name].py (if applicable)
...
- [ ] T026 [P] [US3] Unit tests for [component/function] in tests/unit/test_[name].py
- [ ] T027 [P] [US3] Integration test for [component interaction] in tests/integration/test_[name].py
- [ ] T028 [P] [US3] Contract test for [endpoint] in tests/contract/test_[name].py (if applicable)
